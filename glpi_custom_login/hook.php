   ...
   echo "
      ...
      @media only screen and (max-width: 1024px) {
         ...
         body {
            ...
            height: 100vh;
            width: 100vw;
            background: rgb(247,112,33);
            background: linear-gradient(326deg, rgba(247,112,33,1) 11%, rgba(44,58,83,1) 92%);
         }
         #root-div-dev {
...
function plugin_glpi10() {
   ...
   echo "
      ...
      @media only screen and (max-width: 1024px){
          ...
          .celular{
            content: url('../templates/pages/logo_branca.png');
          }
      ...
      @media only screen and (min-width: 1025px) {
         ...
         form {
            ...
            box-shadow: -1px 0 8px 0px rgba(255, 255, 255);
            border-radius: 5px;
